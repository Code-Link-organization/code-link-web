...
function ForgetPassword() {
  ...
  formdata.append('email',formData.email)
   dispatch(sendEmail({formData:formdata,forgetPassword:true}))
      ...
      if(userData.user && !userData.verified) return <Navigate to='/verification' replace={true}/>
    return (
    <>
    ...
    <form className='w-[498px]' onSubmit={submitFormHandler}>
      ...
      <InputField formData={formData} setFormData={setFormData} {...inputs[0]}/>
                  {userData.loading?<ReactLoading className="mx-auto mt-7" type={'spin'} color={"#D9C6A4"} height={50} width={50} />:
